...
func GenerateArrowCursor() *image.RGBA {
	...
	rows := [32]string{
		...
		"..WBBBBBBBBBBBBBBBBBBBBBBW......", // row 13 (22 B)
		"..WBBBBBBBBBBBBBBBBBBBBBBBRRW...", // row 14 (23 B + 2 R)
		"..WBBBBBBBBBBBBBBBBBBBBBBBBRRRW.", // row 15 (24 B + 3 R)
		"..WBBBBBBBBBBBBBBBBBBBBBBBBRRRRW", // row 16 (24 B + 4 R, tip)
		"..WBBBBBBBBBBBBBBBBBBBBBBBBRRRW.", // row 17 (24 B + 3 R)
		"..WBBBBBBBBBBBBBBBBBBBBBBBRRW...", // row 18 (23 B + 2 R)
		"..WBBBBBBBBBBBBBBBBBBBBBBW......", // row 19 (22 B)
