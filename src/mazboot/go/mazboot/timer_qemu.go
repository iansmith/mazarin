...
func timerInit() {
	...
	isenabler0 := mmio_read(0x08000100) // GICD_ISENABLER0
	...
	busy_wait(1000000) // Wait ~1ms worth of cycles
...
func checkTimerStatus() {
	...
	irqId := timer_irq_id()
	ispendr0 := mmio_read(0x08000200) // GICD_ISPENDR0
	...
	hppir := mmio_read(0x08010018) // GICC_HPPIR
