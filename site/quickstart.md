...
## Warning, QEMU via homebrew is busted
It appears there is something wrong with the qemu 10.2.0 recipie in homebrew.  
The symlink in /opt/homebrew/bin/qemu-system-x86_64 is broken in the default 
installation.   This is true even if you use the --build-from-source option.  It
appears you need to use the --build-from-source option _and_ immediately pin the
package if you want the qemu-system-x86_64 symlink to be created correctly.
