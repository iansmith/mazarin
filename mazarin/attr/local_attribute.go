...
// LocalAttr[T] is a type-safe in-process attribute holding a value of type T.
type LocalAttr[T any] struct {
	n       node
	value   T
...
func (a *LocalAttr[T]) nodePtr() *node { return &a.n }

// NewValue creates a value attribute with an initial value.
func NewValue[T any](initial T) *LocalAttr[T] {
	return &LocalAttr[T]{
		value: initial,
...
func NewConstraint[T any](fn func() T, deps ...Noder) *LocalAttr[T] {
	a := &LocalAttr[T]{
		compute: fn,
		n: node{
...
func (a *LocalAttr[T]) SetEager(eager bool) {
	a.n.eager = eager
}

// Eager returns whether this attribute is eager.
func (a *LocalAttr[T]) Eager() bool {
	return a.n.eager
}
