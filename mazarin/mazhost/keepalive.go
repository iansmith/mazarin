...
//
// The shepherd overlay defines runtime.MazKeepAliveSymbols which stores
...
//
// NOTE: This file requires the shepherd overlay. Without it,
// runtime.MazKeepAliveSymbols doesn't exist and the build will fail.
// Any shepherd that loads .maz modules must import this package
