...
//
// KMAZARIN PATCH: Use sign extension for arm64 as well as amd64.
// This is required for kmazarin because the kernel uses TTBR1 addresses
// (0xFFFF...) which have the high bits set. Without sign extension,
// the high bits are lost when unpacking and we get corrupted pointers.
//
// The sign extension works because:
// - Userspace addresses (TTBR0): bit 47 = 0, sign extends to 0x0000...
