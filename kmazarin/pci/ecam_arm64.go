...
// pciEcamBase is the PCI ECAM base address for ARM64.
// QEMU virt machine with highmem (default): 0x4010000000
var pciEcamBase uintptr = 0x4010000000

// PCI_MMIO_BASE is the PCI MMIO window for BAR reprogramming on ARM64.
// On QEMU virt, 0x10000000 is the PCI MMIO aperture.
