---
description: Build and run ARM64 HVF with a 45 second timeout
user-invocable: true
---

Build and run the ARM64 HVF version of the code with a 45 second timeout. Use the safe serial reader to view output.
...
$GO tool task run-arm64-hvf TIMEOUT=45
```
